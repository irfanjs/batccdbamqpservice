...
public class BatccHelper {
	 static Logger log = Logger.getLogger(BatccHelper.class.getName());
	
	static private BatccHelper cihelper;
	...
	public static BatccHelper getInstance(){
		synchronized (cihelperLock) {
			if(null == cihelper){
				cihelper = new BatccHelper();
			}
		}
		return cihelper;
	}
